...
// import { useCallback } from 'react';
// import { useMutation } from '@apollo/client';
// import { onCreateInputs, onDeleteInputs, onUpdateInputs } from './pizza-Mutation-Input';
// import { GET_PIZZAS } from '../graphql/pizza/queries/get-pizzas';
// import { CREATE_PIZZA, DELETE_PIZZA, UPDATE_PIZZA } from '../graphql/pizza/mutations';

// interface UsePizzaMutationsOutput {
//   onCreate: (selectedPizza: onCreateInputs) => void;
//   onDelete: (selectedPizza: onDeleteInputs) => Promise<void>;
//   onUpdate: (selectedPizza: onUpdateInputs) => void;
// }
